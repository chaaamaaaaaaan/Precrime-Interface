...
FIST_THRESHOLD = 0.5  # Normalized distance threshold for closed fist (increased for easier detection)
FIST_DURATION = 0.8  # seconds - how long to hold fist to toggle pause (reduced for faster activation)
