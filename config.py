...
FIST_THRESHOLD = 0.4  # Normalized distance threshold for closed fist (balanced setting)
FIST_DURATION = 1.0  # seconds - how long to hold fist to toggle pause (balanced setting)
